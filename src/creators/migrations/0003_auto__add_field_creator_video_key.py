...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Creator.video_key'
        db.add_column('creators_creator', 'video_key', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Creator.video_key'
        db.delete_column('creators_creator', 'video_key')
    ...
    models = {
        ...
        'creators.status': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 14, 19, 2, 46, 628441)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
