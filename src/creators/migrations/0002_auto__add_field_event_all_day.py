...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('creators_event', 'all_day', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.all_day'
        db.delete_column('creators_event', 'all_day')
    ...
    models = {
        ...
        'creators.status': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 3, 14, 20, 16, 973774)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
