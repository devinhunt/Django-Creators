# Production settings for vice3d project.
...
DATABASE_NAME = '/www/Django-Creators/vice_noisey_production.db'
DATABASE_USER = ''
DATABASE_PASSWORD = ''
DATABASE_HOST = ''
DATABASE_PORT = ''
...
MEDIA_URL = 'http://ec2-175-41-172-10.ap-southeast-1.compute.amazonaws.com/static/'
